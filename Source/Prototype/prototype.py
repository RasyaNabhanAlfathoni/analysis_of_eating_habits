...
def show_prediction_results(result_data, prediction):
    ...
    # Visualization: Age vs Weight - Interactive Scatterplot using Plotly
    scatter_fig = px.scatter(result_df, x=result_df.index, y="Value", title="Age vs Weight", labels={'index': 'Features', 'Value': 'Values'})
